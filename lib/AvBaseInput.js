...
var htmlValidationAttrs = ['min', 'max', 'minLength', 'maxLength', 'pattern', 'required', 'step']; /* eslint react/forbid-prop-types: 0, react/no-unused-prop-types: 0 */
...
var AvBaseInput = function (_Component) {
  ...
  function AvBaseInput(props) {
    ...
    _this.state = { value: props.multiple ? [] : '' };
    _this.validations = {};
    _this.value = '';
