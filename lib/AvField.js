...
var AvField = function (_Component) {
  ...
  AvField.prototype.render = function render() {
    ...
    var input = _react2.default.createElement(
      _AvInput2.default,
      (0, _extends3.default)({ id: id, className: inputClass, size: size, disabled: disabled, readOnly: readOnly }, attributes),
      children
    );
    ...
    return _react2.default.createElement(
      ...
      label && _react2.default.createElement(
        _reactstrap.Label,
        (0, _extends3.default)({ 'for': id, className: labelClass, hidden: labelHidden, size: size }, labelCol, labelAttrs),
        label
      ),
      !check && inputRow,
      !row && feedback,
...
AvField.propTypes = (0, _extends3.default)({}, _AvInput2.default.propTypes, {
