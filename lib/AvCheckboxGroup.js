...
var AvCheckboxGroup = function (_Component) {
  ...
  function AvCheckboxGroup() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      // validate: {},
      value: []
    }, _this._isMounted = false, _this._inputs = [], _this.value = [], _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  AvCheckboxGroup.prototype.updateInputs = function updateInputs() {
    this._inputs.forEach(function (input) {
      return typeof input.setState === 'function' && (0, _reactDom.findDOMNode)(input).firstChild.setCustomValidity('Invalid.') && input.setState.call(input, {});
    });
...
AvCheckboxGroup.propTypes = (0, _extends3.default)({}, _reactstrap.FormGroup.propTypes, {
