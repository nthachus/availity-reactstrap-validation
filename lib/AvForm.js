...
var AvForm = function (_InputContainer) {
  ...
  function AvForm() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _InputContainer.call.apply(_InputContainer, [this].concat(args))), _this), _this._isMounted = false, _this._validateOnSubmitOnly = !!_this.props.validateOnSubmitOnly, _this.state = {
      invalidInputs: {},
      dirtyInputs: {},
      touchedInputs: {},
      badInputs: {},
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                if (_this._validateOnSubmitOnly) {
                  _this._validateOnSubmitOnly = false;
                }
  ...
  AvForm.prototype.render = function render() {
    var _props = this.props,
        ...
        omit12 = _props.validateOnSubmitOnly,
        className = _props.className,
        attributes = (0, _objectWithoutProperties3.default)(_props, ['tag', 'errorMessage', 'model', 'onValidSubmit', 'onInvalidSubmit', 'validate', 'validateOne', 'validateAll', 'validationEvent', 'disabled', 'readOnly', 'beforeSubmitValidation', 'validateOnSubmitOnly', 'className']);
  ...
  AvForm.prototype.setError = function setError(inputName) {
    ...
    if ((invalidInputs[inputName] === undefined && !error || invalidInputs[inputName] === (errText || true)) && error === currentError) {
      return;
    }
    if (error) {
  ...
  AvForm.prototype.validateAll = function () {
    var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(context) {
      ...
      var errors, isValid, _iterator, _isArray, _i, _ref6, inputName, valid, formLevelValidation;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _iterator = (0, _keys2.default)(this._inputs), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);
  ...
  AvForm.prototype.compileValidationRules = function compileValidationRules(input, ruleProp) {
    ...
    return function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(val, context) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                (0, _keys2.default)(ruleProp).forEach(function (rule) {
...
AvForm.propTypes = {
  ...
  validateOnSubmitOnly: _propTypes2.default.bool
};
AvForm.defaultProps = {
